export const UserProfile = () => {
    return ( 
        <div className="flex gap-x-4 w-[36rem] bg-white rounded-lg p-12">
            <img 
                src="https://placewaifu.com/image/200"
                className="self-start w-32  rounded-full border-[11px] border-[#E6EFFA]"
                alt=""
            />
            <div className="space-y-5  text-[#1C2B62]">
                <div>
